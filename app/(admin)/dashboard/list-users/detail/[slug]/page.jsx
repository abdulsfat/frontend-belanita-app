    ...
    return (
        <div className="space-y-6">
            ...
            >
                ...
                <div className="mb-4">
                    <Label>Status</Label>
                    <p className="mt-1 text-gray-800 dark:text-white capitalize">{article.status}</p>
                </div>

                {/* Konten */}
                <div className="mb-4">
                    <Label>Konten</Label>
                    <p className="mt-1 text-gray-800 dark:text-white whitespace-pre-line">{article.content}</p>
                </div>
